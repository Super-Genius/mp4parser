...
public class PropertyBoxParserImpl extends AbstractBoxParser {
    ...
    private static InputStream isoParserProperties = null;
    private static boolean isInited = false;
    
    public PropertyBoxParserImpl(String... customProperties) {
    	
    	// static mapping every time.
    	if (isoParserProperties != null) {
    		if (isInited)
    			return;
    	...
    	InputStream is = isoParserProperties;
    	if (is == null) {
    		is = new BufferedInputStream(getClass().getResourceAsStream("/isoparser-default.properties"));
    	}
    ...
    static public void SetParserProperties(InputStream parseProperties)
    {
    	if (isoParserProperties != null)
    	{
    		try {
				isoParserProperties.close();
			} catch (IOException e) {
    	...
    	isInited = false;
    	isoParserProperties = parseProperties;
    }
